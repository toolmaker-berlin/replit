# `Cairo_jll.jl` (v1.18.0+1)

[![deps](https://juliahub.com/docs/Cairo_jll/deps.svg)](https://juliahub.com/ui/Packages/Cairo_jll/ouRHo?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/fda22249bf68f4520f7e58492c8276495c21614c/C/Cairo/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://gitlab.freedesktop.org/cairo/cairo.git (revision: `3909090108bb2db55330e3eb148aebe664735363`)
