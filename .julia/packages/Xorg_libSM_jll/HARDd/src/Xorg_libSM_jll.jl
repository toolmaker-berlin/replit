...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libSM_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c834827a-8449-5923-a945-d239c165b7dd"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_libSM", artifacts_toml) for e in artifacts["Xorg_libSM"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_libSM; unsupported platform $(triplet(platform_key_abi()))")
else
