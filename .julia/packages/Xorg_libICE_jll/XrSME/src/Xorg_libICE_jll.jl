...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libICE_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f67eecfb-183a-506d-b269-f58e52b52d7c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_libICE", artifacts_toml) for e in artifacts["Xorg_libICE"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_libICE; unsupported platform $(triplet(platform_key_abi()))")
else
