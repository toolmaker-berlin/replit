...
function initrepl(parser::Function;
        ...
        if show_function !== nothing # Hier hat VSCode gemeckert != war falsch
        ...
        startup_text && println("REPL mode $mode_name init. Press $start_key to enter and backspace to exit.")
...
###############
 ...
 atreplinit() do repl
     try
         ...
         println("Fehler init repl romio!")
     end
 end
